...
const SOUNDS : Dictionary[String, AudioStream] = {
	"move" : preload("res://sfx/game/move.ogg"),
	"piece_drop" : preload("res://sfx/game/piece_drop2.ogg"),
	"rotate" : preload("res://sfx/game/rotate.ogg"),
	"line_clear1" : preload("res://sfx/game/line_clear1.ogg"),
	"line_clear2" : preload("res://sfx/game/line_clear2.ogg"),
	"line_clear3" : preload("res://sfx/game/line_clear3.ogg"),
	"line_clear4" : preload("res://sfx/game/line_clear4.ogg"),
	"line_clear5" : preload("res://sfx/game/line_clear5.ogg"),
	"line_clear6" : preload("res://sfx/game/line_clear6.ogg"),
	"line_clear7" : preload("res://sfx/game/line_clear7.ogg"),
	"line_clear8" : preload("res://sfx/game/line_clear8.ogg"),
	"line_clear9" : preload("res://sfx/game/line_clear9.ogg"),
	"line_clear10" : preload("res://sfx/game/line_clear10.ogg"),
	"damage" : preload("res://sfx/game/damage.ogg"),
	"all_clear" : preload("res://sfx/game/all_clear.ogg"),
	"reverse" : preload("res://sfx/game/charge.ogg"),
	"game_over" : preload("res://sfx/game/game_over.ogg"),
	"game_over2" : preload("res://sfx/game/game_over2.ogg"),
}
